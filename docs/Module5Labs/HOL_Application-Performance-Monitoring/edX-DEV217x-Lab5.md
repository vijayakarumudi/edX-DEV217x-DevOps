...
**3.** In the Application Insights telemetry for PartsUnlimitedMRP, select the Settings tile, followed by the Properties tile to find the Instrumentation key. 
